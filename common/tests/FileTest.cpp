...
{
    ASSERT_EQ(readFileAsString("../common/input/test.in"), "dasfdsgfskhgfjsddskf289e23");
}

TEST_F(FileTest, read_file_as_vector_of_int)
{
    std::vector<int> input = readFileAsArrayInt("../common/input/testArrayInt.in");
...
{
    std::vector<long long> input = readFileAsArrayLongLong("../common/input/testArrayIntWithSeparator.in", ",");
...
{
    std::vector<std::string> output = readFileAsArrayString("../common/input/testArrayInt.in");
