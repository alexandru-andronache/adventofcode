...
namespace aoc2025_day11 {
    ...
    TEST(Test2025Day11, part_1_test) {
        ASSERT_EQ(aoc2025_day11::part_1("../2025/day11/input_test.in"), 0);
    }

    TEST(Test2025Day11, part_1_real_test) {
        ASSERT_EQ(aoc2025_day11::part_1("../2025/day11/input.in"), 0);
    }

    TEST(Test2025Day11, part_2_test) {
        ASSERT_EQ(aoc2025_day11::part_2("../2025/day11/input_test.in"), 0);
    }

    TEST(Test2025Day11, part_2_real_test) {
        ASSERT_EQ(aoc2025_day11::part_2("../2025/day11/input.in"), 0);
    }
#endif
