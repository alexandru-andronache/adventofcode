...
namespace aoc2025_day09 {
    ...
    TEST(Test2025Day09, part_1_test) {
        ASSERT_EQ(aoc2025_day09::part_1("../2025/day09/input_test.in"), 0);
    }

    TEST(Test2025Day09, part_1_real_test) {
        ASSERT_EQ(aoc2025_day09::part_1("../2025/day09/input.in"), 0);
    }

    TEST(Test2025Day09, part_2_test) {
        ASSERT_EQ(aoc2025_day09::part_2("../2025/day09/input_test.in"), 0);
    }

    TEST(Test2025Day09, part_2_real_test) {
        ASSERT_EQ(aoc2025_day09::part_2("../2025/day09/input.in"), 0);
    }
#endif
