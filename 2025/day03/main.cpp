...
namespace aoc2025_day03 {
    ...
    TEST(Test2025Day03, part_1_test) {
        ASSERT_EQ(aoc2025_day03::part_1("../2025/day03/input_test.in"), 0);
    }

    TEST(Test2025Day03, part_1_real_test) {
        ASSERT_EQ(aoc2025_day03::part_1("../2025/day03/input.in"), 0);
    }

    TEST(Test2025Day03, part_2_test) {
        ASSERT_EQ(aoc2025_day03::part_2("../2025/day03/input_test.in"), 0);
    }
