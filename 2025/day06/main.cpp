...
namespace aoc2025_day06 {
    ...
    TEST(Test2025Day06, part_1_test) {
        ASSERT_EQ(aoc2025_day06::part_1("../2025/day06/input_test.in"), 0);
    }

    TEST(Test2025Day06, part_1_real_test) {
        ASSERT_EQ(aoc2025_day06::part_1("../2025/day06/input.in"), 0);
    }

    TEST(Test2025Day06, part_2_test) {
        ASSERT_EQ(aoc2025_day06::part_2("../2025/day06/input_test.in"), 0);
    }

    TEST(Test2025Day06, part_2_real_test) {
        ASSERT_EQ(aoc2025_day06::part_2("../2025/day06/input.in"), 0);
    }
#endif
