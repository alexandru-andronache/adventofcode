...
TEST(Tests2023Day17, part_1_test) {
    ASSERT_EQ(aoc2023_day17::part_1("../2023/day15/input_test.in"), 0);
}

TEST(Tests2023Day17, part_1_real_test) {
    ASSERT_EQ(aoc2023_day17::part_1("../2023/day15/input.in"), 0);
}

TEST(Tests2023Day17, part_2_test) {
    ASSERT_EQ(aoc2023_day17::part_2("../2023/day15/input_test.in"), 0);
}

TEST(Tests2023Day17, part_2_real_test) {
    ASSERT_EQ(aoc2023_day17::part_2("../2023/day15/input.in"), 0);
}
#endif
